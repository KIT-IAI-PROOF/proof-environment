...
To **stop PROOF**, simply use the controlPROOF script in the proof-environment directory:
```
./controlPROOF
```
**Windows:** Stop PROOF using the controlPROOF.bat file.

- use the '-d' option to remove the containers instead of simply stopping them:
```
./controlPROOF -d
```
